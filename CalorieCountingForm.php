...
<body>
    ...
    if (($handle = fopen("food_calories.csv", "r")) !== false) {
        ...
        <input type="number" name="serving_size" id="serving_size" value="0" min="0" required><br><br>

        <label for="calorie_amount">Calorie Amount:</label>
        <input type="number" name="calorie_amount" id="calorie_amount" required <?php if (
